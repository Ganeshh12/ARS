    ...
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      ...
      <DialogContent>
        ...
        <Grid container spacing={2} sx={{ mt: 1 }}>
          ...
          <Grid item xs={12} md={6}>
            <TextField fullWidth label="Registration Number" value={formData.registration_number} disabled />
          </Grid>
      ...
      <DialogActions>
        ...
        <Button onClick={onSubmit} variant="contained" disabled={!formData.student_id || !formData.title || !formData.issue_date || !formData.issuing_organization}>
